...
function SelectTrigger({
  ...
  // Height/radius per size are emitted as PLAIN utility classes (not
  // data-[size=…] attribute selectors) so that a height passed via `className`
  // — e.g. the public reservation form's `h-11` — reliably wins through
  // tailwind-merge's last-wins ordering instead of losing on specificity.
  const sizeClasses =
